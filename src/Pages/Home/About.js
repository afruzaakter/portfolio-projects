...
const About = () => {
    return (
        <div>
            <Section></Section>
            <div className="lg:hero ml-16 lg:min-h-screen lg:bg-base-200 sm:bg-base-0">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div>
                    <img src={myprofile} className="lg:max-w-sm md:max-w-lg md:mt-16 lg:mt-0 mt-14  rounded-lg shadow-2xl animate__animated animate__zoomInDown" />
                    </div>
                </div>
            </div>
        </div>
